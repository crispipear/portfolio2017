var projects = [
  ...
  {
    name: "Imdy ARG",
    type: "marketing campaign, game design",
    des: "Alternate reality game that brings awareness to social impacts by climate change.",
    img: "imdy_tn.png",
    href: "imdyarg.html"
  },
  {
  ...
  {
    name: "Pocket Husky",
    type: "ui/ux design, mobile app concept",
...
$(document).ready(function(){
  ...
  function updateProj(projName){
    ...
    $('.proj-item').addClass("slideIn");
    $('.proj-item').css("margin-right", "-250px").addClass("slideIn");
