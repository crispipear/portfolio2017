...
$(document).ready(function(){
  var nav =   '<nav class="load-menu"><div id="menu"><a id="nav-top" class="underline">HOME</a>'
        +'<a id="nav-ixd" class="underline">WORK</a><a id="nav-about" class="underline">ABOUT</a></div>'
  ...
  if(window.location.hash && window.location.hash == '#projsTag'){
    ...
    $('.proj-div').css('transform', 'translateY(0%)');
  }
  ...
  $(window).scroll(function() {
    var objectScroll = $('#about').offset().top;
    var windowScroll = $(window).scrollTop();
    if (windowScroll >= objectScroll- 50) {
      $('.col-4').css({
