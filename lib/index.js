...
$(document).ready(function(){
  ...
  $('.proj-menu h3').on('click touchstart', function(){
  ...
  $('.proj-des a').on('click touchstart', function() {
    $('#load').css('width', '100%')
  });
  ...
  function updateProj(projName){
    ...
    setTimeout(function(){
      ...
      $('.proj-item .cotButton').attr("data-href", proj.href);
    },500);
    projHover(index);
  }
...
function drawBg() {
  ...
  if(window.innerWidth>1550){
    image = document.getElementById('bgImg_desktop');
  }else if(window.innerWidth>1024){
    image = document.getElementById('bgImg_laptop');
  }else if(window.innerWidth<=1023){
    image = document.getElementById('bgImg_mobile');
  }
