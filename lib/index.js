...
$(document).ready(function(){
  var nav =   '<nav class="load-menu"><div id="burger"><span></span><span></span><span></span></div>'
        +'<div id="menu"><a id="nav-top" class="underline">HOME</a><a id="nav-ixd" class="underline">WORK</a><a id="nav-about" class="underline">ABOUT</a></div></nav>';
  $('body').append(nav)
  drawBg();
  ...
  $(window).scroll(function() {
    ...
    let windowScroll = $(window).scrollTop();
    if (windowScroll >= objectScroll- 100) {
      $('.col-4').css({
