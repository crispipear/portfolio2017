...
$(window).scroll(function() {
  ...
  var topPage = '<img src="../files/back.svg" id="nav-top" class="nav"><img src="../files/back.svg" id="nav-back" data-href="../index.html#projs" class="exitPage nav"/>';
  ...
  var footer = '<div id="footer"><span>Copyright &#xA9; 2018 &#x1F60E; Built by Su Li</span></div>';
  $('body').append(footer);
