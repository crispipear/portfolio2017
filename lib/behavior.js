...
$(window).scroll(function() {
  ...
  $('.proj-ti div, .proj-ti img').each(function() {
    let objectScroll = $(this).offset().top;
    let windowScroll = $(window).scrollTop();
    if ((windowScroll >= objectScroll - 250)) {
      $(this).animate({
        opacity: 1
      }, 1000)
  ...
  $('.proj-sec, .proj-full-img').each(function() {
    let objectScroll = $(this).offset().top;
    let windowScroll = $(window).scrollTop();
    if ((windowScroll >= objectScroll - 500)) {
      $(this).animate({
        opacity: 1
      }, 750)
  ...
  $(document).on('click touchstart', '.exitPage', function(){
    ...
    setTimeout(function(){$('body').css('overflow', 'hidden');}, 725);
