...
$(document).ready(function() {
  ...
  $('.bubble').first().addClass("chat").delay(1250).queue(function(){
    $('.bubble:nth-child(2)').addClass("chat").delay(1500).queue(function(){
      $('.bubble:nth-child(3)').addClass("chat").delay(1500).queue(function(){
        $('.bubble:nth-child(4)').addClass("chat").delay(1750).queue(function(){
          $('.bubble:nth-child(5)').addClass("chat").delay(1250).queue(function(){
            $('.about').addClass("chat");
          });;;
        });;
      });;
